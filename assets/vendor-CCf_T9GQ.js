...
var padStart = function padStart2(string, length2, pad) {
  var s2 = String(string);
  if (!s2 || s2.length >= length2) return string;
  return "" + Array(length2 + 1 - s2.length).join(pad) + string;
};
...
var Dayjs = /* @__PURE__ */ function() {
  ...
  _proto.$set = function $set(units, _int) {
    ...
    var unit = Utils.p(units);
    var utcPad = "set" + (this.$u ? "UTC" : "");
    var name = (_C$D$C$DATE$C$M$C$Y$C = {}, _C$D$C$DATE$C$M$C$Y$C[D] = utcPad + "Date", _C$D$C$DATE$C$M$C$Y$C[DATE] = utcPad + "Date", _C$D$C$DATE$C$M$C$Y$C[M] = utcPad + "Month", _C$D$C$DATE$C$M$C$Y$C[Y] = utcPad + "FullYear", _C$D$C$DATE$C$M$C$Y$C[H] = utcPad + "Hours", _C$D$C$DATE$C$M$C$Y$C[MIN] = utcPad + "Minutes", _C$D$C$DATE$C$M$C$Y$C[S] = utcPad + "Seconds", _C$D$C$DATE$C$M$C$Y$C[MS$1] = utcPad + "Milliseconds", _C$D$C$DATE$C$M$C$Y$C)[unit];
  ...
  _proto.format = function format(formatStr) {
    ...
    var matches = function matches2(match2) {
      switch (match2) {
        case "YY":
...
[["$ms", MS$1], ["$s", S], ["$m", MIN], ["$H", H], ["$W", D], ["$M", M], ["$y", Y], ["$D", DATE]].forEach(function(g) {
...
var u = function u2(formatStr, formats) {
  return formatStr.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g, function(_, a, b) {
    ...
    return a || formats[b] || englishFormats[b] || t$1(formats[B]);
  });
};
...
var s = { strings: ["These are the default values...", "You know what you should do?", "Use your own!", "Have a great day!"], stringsElement: null, typeSpeed: 0, startDelay: 0, backSpeed: 0, smartBackspace: true, shuffle: false, backDelay: 700, fadeOut: false, fadeOutClass: "typed-fade-out", fadeOutDelay: 500, loop: false, loopCount: Infinity, showCursor: true, cursorChar: "|", autoInsertCss: true, attr: null, bindInputFocusEvents: false, contentType: "html", onBegin: function(t3) {
  ...
  return n2.load = function(e3, n3, i2) {
    ...
    for (var u3 in e3.strPos = 0, e3.currentElContent = this.getCurrentElContent(e3), e3.currentElContent && e3.currentElContent.length > 0 && (e3.strPos = e3.currentElContent.length - 1, e3.strings.unshift(e3.currentElContent)), e3.sequence = [], e3.strings) e3.sequence[u3] = u3;
  ...
  return s2.typeHtmlChars = function(t4, s3, e2) {
    ...
    if ("<" === n2 || "&" === n2) {
      var i2;
      for (i2 = "<" === n2 ? ">" : ";"; t4.substring(s3 + 1).charAt(0) !== i2 && !(1 + ++s3 > t4.length); ) ;
      s3++;
    }
    return s3;
    ...
    if (">" === n2 || ";" === n2) {
      var i2;
      for (i2 = ">" === n2 ? "<" : "&"; t4.substring(s3 - 1).charAt(0) !== i2 && !(--s3 < 0); ) ;
      s3--;
    }
    return s3;
  }, t3;
  ...
  return s2.toggle = function() {
    ...
    true !== this.pause.status ? this.timeout = setTimeout(function() {
      ...
      var i3 = 0, o = t4.substring(s3);
      if ("^" === o.charAt(0) && /^\^\d+/.test(o)) {
        var a = 1;
        a += (o = /\d+/.exec(o)[0]).length, i3 = parseInt(o), e2.temporaryPause = true, e2.options.onTypingPaused(e2.arrayPos, e2), t4 = t4.substring(0, s3) + t4.substring(s3 + a), e2.toggleBlinking(true);
      }
      if ("`" === o.charAt(0)) {
        for (; "`" !== t4.substring(s3 + r).charAt(0) && (r++, !(s3 + r > t4.length)); ) ;
        var u3 = t4.substring(0, s3), p = t4.substring(u3.length + 1, s3 + r), c = t4.substring(s3 + r + 1);
        t4 = u3 + p + c, r--;
      }
    ...
    }, i2) : this.setPauseStatus(t4, s3, true);
